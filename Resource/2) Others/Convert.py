...
try:
    ...
    for i in range(1, 21):
        ...
        # Make sure to add something unique and least used sequence
        # There were errors when ',' was used;
        # commas were already in the question and it created more than 5 elements.
        ...
        list_individual = e.split(
            "zzzzz")  # ['Question  ', ' Anser(choice)  ', ' Choice_1 ', ' Choice_2 ', ' Choice_3']
        # 5 elements: Question, Answer, Option_1, Option_2, Option_3

        total_list.append(
            list_individual)  # [['Question  ', ' Anser(choice)  ', ' Choice_1 ', ' Choice_2 ', ' Choice_3']]
